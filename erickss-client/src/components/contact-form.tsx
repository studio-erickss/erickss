...
export default async function ContactForm() {
    return (
        <div className="py-8 px-4 mx-auto max-w-screen-md glass rounded-2xl">
            ...
            <p className="mb-8 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Leave a message and we will get back to you right away.</p>
            <form action="#" className="space-y-2 flex flex-col gap-1">
                ...
                <button type="submit" className="bg-secondary self-end py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Send message</button>
            </form>
        </div>
    );
}
