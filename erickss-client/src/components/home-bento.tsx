...
const SkeletonFour = () => {
    ...
    return (
        ...
        >
            ...
            >
                <Image
                    src="/images/custom-abstract.jpeg"
                    alt="avatar"
                    height="100"
                    width="100"
        ...
        >
            ...
            >
                ...
                <p className="text-xs text-neutral-500">
                    Are you looking for a particular custom design or products in non-standard dimensions not found in our inventory? 
                    Feel free to inform us, and we'll collaborate with you to create items tailored to your exact specifications.
                </p>
            </motion.div>
            <motion.div
                variants={variantsSecond}
            ...
            >
                ...
                <div className="h-6 w-6 rounded-full bg-gradient-to-r from-orange-500 to-green-500 flex-shrink-0" />
            </motion.div>
        </motion.div>
    );
};
const items = [
    ...
    },
    {
        ...
        description: (
            <span className="text-sm">
                Unmatched client and quality services
            </span>
        ),
        header: <SkeletonFour />,
...

    {
        ...
        description: (
            <span className="text-sm">
                If you need custom designs or non-standard dimensions, we'll create tailored items for you.
            </span>
        ),
        header: <SkeletonFive />,
